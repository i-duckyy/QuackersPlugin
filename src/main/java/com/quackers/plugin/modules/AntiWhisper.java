...
public class AntiWhisper extends Module {
    public AntiWhisper() {
        super(QuackersPlugin.CATEGORY, "anti-whisper", "Notifies you when someone receives a private message.");
    }
    ...
    public static void addSeenSignature(final UUID sender, final ByteBuffer signature) {
        ...
        final String message = "§#FF8600Q§#FF9200u§#FF9D00a§#FFA900c§#FFB500k§#FFC000e§#FFCC00r §#FFE300> §r" + (names.size() == 1 ? names.get(0) : joinedNames) + " " + verb + " saw a message you haven't!";
